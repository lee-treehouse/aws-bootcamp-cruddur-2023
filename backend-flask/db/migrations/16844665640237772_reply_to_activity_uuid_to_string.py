...
class ReplyToActivityUuidToStringMigration:
  def migrate_sql():
    data = """
    ALTER TABLE public.activities DROP COLUMN reply_to_activity_uuid;
    ALTER TABLE public.activities ADD COLUMN reply_to_activity_uuid uuid;
    """
    return data
  def rollback_sql():
    data = """
    ALTER TABLE public.activities DROP COLUMN reply_to_activity_uuid;
    ALTER TABLE public.activities ADD COLUMN reply_to_activity_uuid integer;
    """
    return data
